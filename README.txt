=== STL Wireframe Styles ===
Contributors: Kirsten Schelper
Donate link: https://start-the-loop.com
Tags: wireframe, prototyping
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

Gives your theme a wireframy look. Meant for pre-design prototyping. 
...
1. Upload `stl_wireframe.php` to the `/wp-content/plugins/` directory
...
= I cant see a wireframe look with my theme. =
...
The plugin works for many other themes, too. But the HTML structure varies.
